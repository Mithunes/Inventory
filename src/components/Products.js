        ...
        <>
            ...
            <div className='container-fluid p-5'>
                ...
                <div className="d-flex" role="search">
                    <input className="form-control me-2" type="search" placeholder="Search" onChange={(e)=>{setSearchText(e.target.value)}} aria-label="Search" />
                    <button className="btn btn-primary fs-5" type="submit" onClick={()=>{handleSearch()}}>Search</button>
                </div>
